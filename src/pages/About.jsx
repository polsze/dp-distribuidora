...
const values = [
  {
    ...
    description: "Buscamos resolver problemas, no solo vender repuestos. Cada solución está diseñada para optimizar el rendimiento de su maquinaria."
  },
  {
    icon: Shield,
    title: "Calidad Garantizada",
    description: "Trabajamos exclusivamente con repuestos de calidad certificada, garantizando durabilidad y compatibilidad total."
  },
  {
    icon: Clock,
    title: "Respuesta Rápida",
    description: "Entendemos que el tiempo es crítico. Ofrecemos respuestas y soluciones en tiempo récord para minimizar paradas."
  },
  {
    icon: BookOpen,
    title: "Conocimiento Técnico",
    description: "Contamos con acceso a todos los manuales de partes para garantizar la precisión en cada solución técnica."
  }
];
...
const timeline = [
  {
    year: "2008",
    title: "Inicios",
    description: "Fundación de DP Distribuidora con el objetivo de brindar soluciones confiables para maquinaria vial."
  },
  {
    year: "2012",
    title: "Expansión de Marcas",
    description: "Ampliación de nuestro catálogo para incluir las principales marcas internacionales del sector."
  },
  {
    year: "2016",
    title: "Base de Manuales",
    description: "Implementación de la base completa de manuales de partes para todos los modelos y equipos."
  },
  {
    year: "2020",
    title: "Cobertura Nacional",
    description: "Expansión logística para ofrecer envíos a todo el país con tiempos optimizados."
  },
  {
    year: "2024",
    title: "Servicio Integral",
    description: "Consolidación como proveedor integral con soporte técnico especializado y asesoramiento completo."
  }
];
              ...
              <div>
                ...
                <div className="relative mb-10">
                  ...
                  <blockquote className="pl-8 italic text-xl text-gray-300 leading-relaxed">
                    "Estamos aquí para garantizar que su maquinaria siga funcionando sin interrupciones, porque entendemos que su tiempo es invaluable"
                  </blockquote>
                </div>

                <p className="text-lg text-gray-300 leading-relaxed mb-10">
                  En <span className="text-yellow-400 font-semibold">DP Distribuidora S.R.L.</span> combinamos 
                  la energía de una empresa joven con más de <span className="font-bold">15 años de experiencia</span> en el rubro. 
                  Sabemos exactamente lo que su maquinaria necesita para mantener el ritmo en los trabajos más exigentes.
                </p>
                  ...
                  <div className="aspect-square bg-linear-to-br from-gray-800 to-black flex items-center justify-center p-12">
                    <div className="text-center">
                      ...
                      <p className="text-gray-300">
                        Más que distribuidores, somos socios estratégicos en el mantenimiento de su flota
                      </p>
                    </div>
                  </div>
          ...
          <FadeInSection delay={200}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                En DP Distribuidora entendemos la importancia de contar con soluciones rápidas y precisas 
                para el mantenimiento y reparación de maquinaria pesada.
              </p>
            </div>
          </FadeInSection>
                  ...
                  <div className="relative bg-white rounded-2xl p-8 border border-gray-200 shadow-lg hover:shadow-xl hover:border-yellow-400/30 transition-all duration-500">
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100 group-hover:border-yellow-400/30 transition-colors duration-300">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-500">Valor fundamental</span>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  <div>
                    <div className="inline-flex items-center gap-2 mb-6">
                      ...
                      <span className="text-yellow-400 font-bold">VENTAJA TÉCNICA</span>
                    </div>
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed mb-8">
                      Trabajamos con las marcas más reconocidas del sector y disponemos de una 
                      <span className="text-yellow-300 font-semibold"> base completa de manuales de partes</span> &bnsp; 
                      para todos los modelos y equipos. Esto nos permite garantizar soluciones rápidas, 
                      precisas y confiables.
                    </p>
                    
                    <div className="flex items-center gap-3">
                      <CheckCircle className="text-yellow-400" size={20} />
                      <span className="font-medium">Compatibilidad 100% garantizada</span>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                      {brands.map((brand, index) => (
                        ...
                        >
                          ...
                          <div className="text-xs text-gray-400 mt-1">Repuestos originales</div>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/10">
                      <p className="text-gray-300 text-sm">
                        Trabajar con todas las marcas y contar con todos los manuales de partes 
                        nos permite garantizar soluciones rápidas, precisas y confiables.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center">
              ...
              <div className="relative mb-12">
                ...
                <div className="relative bg-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-2xl">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                    No solo ofrecemos repuestos; proporcionamos <span className="text-yellow-600">tranquilidad</span>
                  </h3>
                  
                  <p className="text-lg text-gray-700 leading-relaxed mb-8">
                    Apreciamos su tiempo y atención, y estamos comprometidos a ofrecerle el mejor servicio 
                    y productos de calidad. Quedamos a su disposición para cualquier consulta adicional y 
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-16">
                <div className="text-center p-6 bg-white rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-gray-600">Posadas, Misiones</p>
                  <p className="text-sm text-gray-500 mt-2">Envios a todo el país</p>
                </div>
                ...
                <div className="text-center p-6 bg-white rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-gray-600 font-bold">+54 9 3764 22-2222</p>
                  <p className="text-sm text-gray-500 mt-2">Disponible de Lunes a Viernes</p>
                </div>
                ...
                <div className="text-center p-6 bg-white rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-gray-600">info@dpdistribuidora.com.ar</p>
                  <p className="text-sm text-gray-500 mt-2">Respondemos en 24h</p>
                </div>
              </div>
